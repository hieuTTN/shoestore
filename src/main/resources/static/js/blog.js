...
async function loadBlog(page) {
    var url = 'http://localhost:8080/api/blog/public/findAll-page?page=' + page + '&size=' + sizeblog + '&sort=id,desc';
        ...
        main += `<div class="col-lg-4 col-md-6 col-sm-12 col-12 singleblog">
                    <div class="row">
                        ...
                        <div class="col-7 cntblog">
                            ...
                            <div class="userblog">
                                <img src="${list[i].user.avatar==null?'':list[i].user.avatar}" class="avtyo">
...
async function loadPrimaryBlog() {
    var url = 'http://localhost:8080/api/blog/public/new-blog';
    const response = await fetch(url, {
        method: 'GET'
    });
...
async function loadBlogIndex() {
    var url = 'http://localhost:8080/api/blog/public/findAll-page?page=0&size=' + sizeblog + '&sort=id,desc';
    const response = await fetch(url, {
        method: 'GET'
    });
    var result = await response.json();
